...
func (a *App) GetTemplate(c echo.Context) error {
	...
	id := getID(c)
	out, err := a.mailviewCore(c).GetTemplate(id, noBody)
	if err != nil {
		return err
	}
...
func (a *App) GetTemplates(c echo.Context) error {
	...
	out, err := a.mailviewCore(c).GetTemplates("", noBody)
	if err != nil {
		return err
	}
...
func (a *App) PreviewTemplate(c echo.Context) error {
	...
	id := getID(c)
	tpl, err := a.mailviewCore(c).GetTemplate(id, false)
	if err != nil {
		return err
	}
...
func (a *App) CreateTemplate(c echo.Context) error {
	...
	out, err := a.mailviewCore(c).CreateTemplate(o.Name, o.Type, o.Subject, []byte(o.Body), o.BodySource)
	if err != nil {
		return err
	}
...
func (a *App) UpdateTemplate(c echo.Context) error {
	...
	id := getID(c)
	out, err := a.mailviewCore(c).UpdateTemplate(id, o.Name, o.Subject, []byte(o.Body), o.BodySource)
	if err != nil {
		return err
	}
...
func (a *App) TemplateSetDefault(c echo.Context) error {
	// Update the template in the DB.
	id := getID(c)
	if err := a.mailviewCore(c).SetDefaultTemplate(id); err != nil {
		return err
	}
...
func (a *App) DeleteTemplate(c echo.Context) error {
	...
	id := getID(c)
	if err := a.mailviewCore(c).DeleteTemplate(id); err != nil {
		return err
	}
