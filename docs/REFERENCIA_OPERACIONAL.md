...
Build: Go 1.26.1, Node 22, Yarn 1.22, Vue 2.7.14 e Vite 5.4. Runtime: Alpine 3.23, PostgreSQL 17 e Docker Compose v2. Targets estão na configuração GoReleaser.
